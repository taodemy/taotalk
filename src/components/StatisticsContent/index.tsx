...
const StatisticsContent = () => {
  type PageType = 'For the day' | 'For all the time';

  const [pageType, setPageType] = useState<PageType>('For the day');
  ...
  const page_data = pageType === 'For the day' ? today_statistics : all_time_statistics;
  ...
  return (
    <main className="flex flex-col items-center justify-center gap-[40px] bg-tk_greyLight py-[100px]">
      <section className="flex gap-[40px]">
        <h4
          className={
            pageType === 'For the day' ? 'underline underline-offset-[16px]' : 'text-tk_greyDark'
          }
          onMouseEnter={() => setPageType('For the day')}
        >
          For the day
        </h4>
        <h4
          className={
            pageType === 'For all the time'
              ? 'underline underline-offset-[16px]'
              : 'text-tk_greyDark'
          }
          onMouseEnter={() => setPageType('For all the time')}
        >
          For all the time
        </h4>
      </section>
