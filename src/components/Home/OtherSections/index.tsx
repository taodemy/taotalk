    ...
    <>
      ...
      <section className="bg-gray-100">
        <div className="mx-auto grid xs:px-[8px] xs:py-[16px] md:max-w-[1216px] md:px-[32px] md:py-[40px] xl:max-w-[1180px] xl:grid-cols-2 xl:gap-[26px] xl:pb-0 xl:pt-[26px]">
          <div className="mx-0 my-auto flex flex-col xs:ml-0 xl:ml-[100px] xl:block">
            <HeadingDescription
      ...
      <section className="mx-auto grid xs:px-[8px] xs:py-[16px] md:max-w-[1216px] md:px-[32px] md:py-0 xl:max-w-[1180px] xl:grid-cols-2 xl:gap-[20px] xl:py-[95px] ">
